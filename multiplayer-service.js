...
window.FriendService=class {
 ...
 async create(name,challenge=null){const data=await this.request(challenge?'/challenges':'/rooms',{name,...(challenge||{})},false);this.suspended=false;this.session={code:data.code,token:data.token,api:this.api};this.save();return this.accept(data);}
